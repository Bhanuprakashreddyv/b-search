...
export const Navbar = ({ darkTheme, setDarkTheme}) => {
  return (
    <div className='p-5 pb-0 flex flex-wrap sm:justify-between justify-center items-center border-b dark:border-grayy-700 border-gray-200'>
        <div className='flex justify-between items-center space-x-5 w-screen'>
            ...
            <p className='text-2xl bg-blue-500 font-bold text-white py-1 px-2 rounded-full dark:bg-gray-500 dark:text-gray-900'>
                B Search <i className='fa fa-search'></i>
            </p>
            </Link>
